      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 text-white">
          ...
          <h1 className="text-4xl font-bold mb-4 leading-tight">
            Start your journey with<br />NovaPulse today
          </h1>
          <p className="text-lg text-white/80 mb-8">
            Join thousands of teams already using NovaPulse to streamline their operations.
          </p>
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/70">Start with our free tier and upgrade when ready</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0 mt-1">
              ...
              <div>
                ...
                <p className="text-sm text-white/70">Build powerful workflows with NovaFlow</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0 mt-1">
              ...
              <div>
                ...
                <p className="text-sm text-white/70">Get help whenever you need it</p>
              </div>
            </div>
          </div>
        </div>
